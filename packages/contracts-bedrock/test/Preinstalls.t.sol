...
contract PreinstallsTest is CommonTest {
    ...
    function test_preinstall_basicPaymaster_succeeds() external view {
        assertPreinstall(Preinstalls.BasicPaymaster, Preinstalls.BasicPaymasterCode);
    }

    function test_preinstall_basicAccount_succeeds() external view {
        assertPreinstall(Preinstalls.BasicAccount, Preinstalls.BasicAccountCode);
    }
}
